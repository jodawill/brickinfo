...
<form method="post" action="options.php">
 ...
 <table class="form-table">
  ...
  <tr valign="top">
   ...
   <td><input type="number" step="1" name="bi_cache_time" value="<?php echo esc_attr(get_option('bi_cache_time', '24')); ?>" /></td>
  </tr>

  <tr valign="top">
   <th scope="row">Show Negative &amp; Neutral Feedback<br/></th>
   <td><input type="checkbox" name="bi_show_fb_details" <?php if (get_option('bi_show_fb_details', 'on') == "on") echo "checked"; else echo "unchecked"; ?>/></td>
  </tr>
 </table>
 <?php submit_button(); ?>
</form>
